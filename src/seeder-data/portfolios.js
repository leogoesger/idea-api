module.exports = [
  {
    id: 1,
    researchAndEvaluation: JSON.stringify({
    ...
    mentalHealthService: JSON.stringify({
    ...
    policiesAndProcedures: JSON.stringify({
